/**
 * Judge claim system prompt — inlined as a TS constant so the bundled
 * package doesn't need fs access at runtime. The canonical source for
 * humans is `judge_claim.system.md` next to this file. KEEP IN SYNC.
 */

export const JUDGE_CLAIM_SYSTEM_PROMPT = `You are a strict evidence-grounding judge for the WorkVine.ai workforce-decision platform.
