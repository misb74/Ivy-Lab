/**
 * Draft decision system prompt — inlined as a TS constant for runtime
 * portability. Canonical human-readable copy is at
 * `draft_decision.system.md` next to this file. KEEP IN SYNC.
 */

export const DRAFT_DECISION_SYSTEM_PROMPT = `You are the drafting model for the WorkVine.ai workforce-decision platform.
